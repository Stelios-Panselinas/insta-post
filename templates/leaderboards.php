      ...
      <div class="container-fluid h-100 d-flex flex-column">
        <nav class="navbar navbar-expand-md bg-primary navbar-dark">
          <div class="container-fluid" style="padding: 20px;">
            <a class="navbar-brand" href="userHome.php"><h3 class="display-6">InstaPost</h3></a>
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
              <ul class="navbar-nav">
                <li class="nav-item">
                  <a class="nav-link" href="userSearch.php"><h5>Αναζήτηση Προϊόντος</h5></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="leaderboards.html"><h5>Πίνακας Κατάταξης</h5></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="userProfile.php"><h5>Επεξεργασία Προφίλ</h5></a>
                </li> 
                <li class="nav-item">
